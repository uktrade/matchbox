...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["sample_set_id"], ["mb.eval_sample_set.sample_set_id"], ondelete="CASCADE"
        ),
...
def downgrade() -> None:
    ...
    op.drop_constraint(None, "eval_judgements", schema="mb", type_="foreignkey")
    op.drop_column("eval_judgements", "sample_set_id", schema="mb")
    op.drop_table("eval_sample", schema="mb")
    op.drop_table("eval_sample_set", schema="mb")
    # ### end Alembic commands ###
